...
export const Sidebar = () => {
  ...
  const navItems = [
    { icon: LayoutDashboard, label: APP_MESSAGES.SIDEBAR.DASHBOARD, id: 'dashboard' },
    { icon: ArrowDownUp, label: APP_MESSAGES.SIDEBAR.SWAP, id: 'swap', active: true },
    { icon: History, label: APP_MESSAGES.SIDEBAR.HISTORY, id: 'history' },
    { icon: Settings, label: APP_MESSAGES.SIDEBAR.SETTINGS, id: 'settings' },
  ];
  ...
  return (
    <aside className="hidden lg:flex w-72 flex-col border-r border-brand-border p-6 gap-8 bg-brand-bg/50 backdrop-blur-md shrink-0">
      <div className="flex items-center gap-3 px-2">
        ...
        <span className="text-xl font-bold font-display tracking-tight text-white">FancySwap</span>
      </div>
          ...
          <a 
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-colors ${
              item.active 
                ...
                : 'text-brand-secondary hover:bg-brand-border/50'
            }`}
          >
